                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="/uploads/{{Auth::user()->profile}}" style="width: 40px;height: 40px;object-fit: contain; border-radius: 100%;border: 1px solid"/>
                    </div>
                  </a>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          <div class="flex-shrink-0 me-3">
                            <div class="avatar avatar-online">
                              <img src="../uploads/{{Auth::user()->profile}}" style="width: 40px;height: 40px;object-fit: contain; border-radius: 100%"/>
                            </div>
                          </div>
